...
assets_dir = os.path.join(spatial_dir, "assets", "cafe_social")

photo_files = sorted(glob.glob(os.path.join(assets_dir, "cafe_*.jpg")))

print(f"Building cafe_social.html with {len(photo_files)} pure photos.")

photo_items_html = ""
for idx, fpath in enumerate(photo_files):
    rel_path = f"assets/cafe_social/{os.path.basename(fpath)}"
...
print(f"Successfully generated updated cafe_social.html with all {len(photo_files)} photos!")
