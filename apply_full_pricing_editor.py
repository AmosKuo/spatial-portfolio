...
# Replace pricing object in pageContent
sd_code = re.sub(
    r'"pricing":\s*\{.*?\},\n\s*"contact"',
    f'"pricing": {json.dumps(pricing_details, ensure_ascii=False, indent=8)},\n        "contact"',
    sd_code,
    flags=re.DOTALL
)
...
print("site_data.js updated with fine pricing details.")
